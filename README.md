...
<p align="center"><b>광명융합기술교육원 클라우드 5조</b></p>
...
- **평일 아침 알림에 전날 메뉴가 떴습니다.** EC2가 UTC로 동작해서, 한국 새벽엔 `date.today()`가 아직 전날이었습니다. '오늘'을 항상 한국시간(KST=UTC+9)으로 계산하도록 바꿔(`today_kst()`) 해결했습니다.
